...
const Toast = ({ isShown, message, type, onClose }) => {
  ...
  return (
    <div className={`absolute top-20 right-6 transition-all duration-400 ${
      ...
      <div className={`min-w-52 bg-white border shadow-2xl border-slate-300 rounded-md after:w-1.25 after:h-full ${type === "delete" ? "after:bg-red-500" : "after:bg-green-500"} after:absolute after:left-0 after:top-0 after:rounded-l-lg`}>
